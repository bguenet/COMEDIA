...
mtext("Phytoplankton biomass", side=2,line=5,las=0, cex=0.7)
mtext("(gC.l-1)", side=2,line=3.5,las=0, cex=0.7)
...
mtext("Decomposers biomass", side=2,line=5,las=0, cex=0.7)
mtext("(gC.l-1)", side=2,line=3.5,las=0, cex=0.7)
